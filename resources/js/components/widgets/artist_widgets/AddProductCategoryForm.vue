  ...
  <div class="container-fluid pb-5">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="container">
          <form style="padding:40px 60px" @submit.prevent="addProductCategory">
            <div class="form-row">
              ...
              <!-- <div class="form-group col-md-4">
                        ...
                        <multiselect v-model="categorySelected" :options="extractedCategories" :multiple="false" :taggable="true" @tag="addCategory" tag-placeholder="Add this as new tag" placeholder="Type to search a category"> </multiselect>
                     </div> -->
            </div>
...
export default {
  ...
  methods: {
    ...
    addProductCategory() {
      ...
      this.showMsg = false;
      this.$store
        .dispatch("products/add_product_category", {
          name: this.category,
    ...
    addCategory(newCategory) {
      const category = {
        ...
        code:
          newCategory.substring(0, 2) + Math.floor(Math.random() * 10000000),
      };
