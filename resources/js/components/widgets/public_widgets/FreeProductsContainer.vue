                    ...
                    >
                        ...
                        <nav class="velaBreadcrumbWrap container">
                            <div class="velaBreadcrumbsInnerWrap">
                                <h1 class="breadcrumbHeading">Free product</h1>
                                <ol
                                    class="breadcrumb"
                                    itemscope
                ...
                <div class="container">
                    <div class="pageCollectionInner mb20 pb-md-30">
                        <div class="row">
                            <aside
                                id="velaSidebar"
                                class="filterTagFullwidthContent sidebarLeft velaSidebar col-xs-3 col-sm-6 col-md-3 col-xl-3"
                                :class="{ active: showFilter }"
                            >
                                <div
                                    class="filterTagFullwidthClose hidden-xl hidden-lg hidden-md hidden-xl"
                            ...
                            <div
                                ...
                                class="velaCenterColumn velaCenterColumnFix col-xs-12 col-sm-12 col-md-9 col-xl-9"
                            >
                                <div
                                    ...
                                    <div class="collBoxProducts">
                                        ...
                                        >
                                            ...
                                            <div class="rowFlex rowFlexMargin">
                                                <div
                                                    class="velaProBlock grid col-sp-12 col-xs-6 col-md-4 col-lg-3"
...
export default {
    ...
    computed: { ...mapState("products", ["cart", "products", "categories"]) },
    created() {
