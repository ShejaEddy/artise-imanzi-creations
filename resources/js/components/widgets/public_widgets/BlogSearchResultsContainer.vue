            ...
            <section id="pageContent" class="pageBlogContent mb30">
                <div class="container">
                    <div class="velaBlogWrap">
                        <div
                            id="shopify-section-vela-template-blog"
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="blogContainer">
                                        ...
                                        <div
                                            v-else
                                            class="blogListArticle blogGridTemplate"
                                        >
...
export default {
    data: function() {
        return {
            baseUrl: "",
            search_for: this.$route.params.searchFor
        };
    },
    computed: {
        ...mapState({
    ...
    methods: {
        ...mapActions("products", ["search_post"]),

        loadPosts() {
            this.search_post(this.search_for);
        },
        generateBaseUrl() {
