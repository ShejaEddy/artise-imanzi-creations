<template>
  <div class="container-fluid pb-5">
    <h1 class="mt-4">Add Artist</h1>
    <ol class="admin-breadcrumb mb-4">
      <li class="admin-breadcrumb-item">Dashboard</li>
      <li class="admin-breadcrumb-item active">add Artist</li>
    </ol>
    <div class="card">
          ...
          >
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <span
                  ><i
                    ><small class="text-danger" v-if="namesErr">{{
                      errors.name["0"]
                    }}</small></i
                  ></span
                >
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <span
                  ><i
                    ><small class="text-danger" v-if="passwordErr">{{
                      errors.password["0"]
                    }}</small></i
                  ></span
                >
