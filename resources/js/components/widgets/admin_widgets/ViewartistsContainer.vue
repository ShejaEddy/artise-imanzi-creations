<template>
  ...
  <main>
    <div class="container-fluid">
      <h1 class="mt-4">View Artists</h1>
      <ol class="admin-breadcrumb mb-4">
        <li class="admin-breadcrumb-item active">View Artists</li>
      </ol>
      ...
      <div class="card mb-4">
        <div class="card-header">
          ...
          <div style="float:right">
            <router-link to="add-artist" class="btn btn-primary btn-sm"
            ...
            >
              ...
              <tbody v-if="users.length > 0">
                <tr v-for="user in users" :key="user.id">
                  <template v-if="user.role == 'artist'">
                    ...
                    <td>
                      <span
                        v-if="user.products_num > 0"
                        class="badge badge-success"
                        >{{ user.products_num }}</span
                      >
