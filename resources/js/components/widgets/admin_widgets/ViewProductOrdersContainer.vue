         ...
         <div class="card mb-4">
            ...
            <div class="card-body">
               <div class="table-responsive">
                  <div style="display: none" class="col-sm-12"  v-show="productOrders.length === 0">
                     <div class="card">
                        <div class="card-body">
                           <center>
                              <h4
                  ...
                  <div class="modal-dialog modal-lg">
                     <div class="modal-content" v-if="toView[0]">
                        ...
                        <div class="modal-body">
                           <p>
                              <strong>Names: </strong>{{ toView[0].names }}&nbsp;&nbsp;
                              <strong>Phone: </strong>{{ toView[0].phone }}&nbsp;&nbsp; <strong>Price: </strong>{{ toView[0].amount }} RWF &nbsp;&nbsp;
                              <strong>Order Completed: </strong>{{ toView[0].orderCompleted }}&nbsp;&nbsp;
